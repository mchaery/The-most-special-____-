...
<body>
    ...
    <div class="read_btn">
        <button class="read_btn1" style="cursor: pointer" onclick="location.href='./bday.html'">목록</button>&nbsp;&nbsp;
        <?php
        if (isset($_SESSION['userid']) and $_SESSION['userid'] == $rows['id']) { ?>
            <button class="read_btn1" style="cursor: pointer" onclick="location.href='./modify.php?number=<?= $number ?>'">수정</button>&nbsp;&nbsp;
